...
function displayPhotos() {
  ...
  if (!container) {
      console.error("Container with ID 'photoContainer' not found");
      return;
  }
...
function updatePhotoCount() {
    document.getElementById('photoCount').textContent = `Displaying ${photoCount} photos`;
}